...
#import "RCNewsFavoriteCell.h"

@implementation RCNewsFavoriteCell
...
- (void)onAdd:(UIView*)sender
{
    ...
    Favorite_Entry *entry=[self.article.favorites anyObject];
    __weak RCNewsFavoriteCell *me=self;
