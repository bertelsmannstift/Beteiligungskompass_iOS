...
#import "RCMethodFavoriteCell.h"

@implementation RCMethodFavoriteCell
...
- (void)onAdd:(UIView*)sender
{
    ...
    Favorite_Entry *entry=[self.article.favorites anyObject];
    __weak RCMethodFavoriteCell *me=self;
